...
(mapc #'(lambda (entry)
      ...
      '(("cl-ppcre" (cl-lookup-ppcre-root ""))
        ...
        ("create-scanner" (cl-lookup-ppcre-root "#create-scanner"))
        ("create-scanner" (cl-lookup-ppcre-root "#create-scanner2"))
        ("parse-tree-synonym" (cl-lookup-ppcre-root "#parse-tree-synonym"))
        ("define-parse-tree-synonym"
         (cl-lookup-ppcre-root "#define-parse-tree-synonym"))
        ("scan" (cl-lookup-ppcre-root "#scan"))
        ("scan-to-strings" (cl-lookup-ppcre-root "#scan-to-strings"))
        ("register-groups-bind"
         (cl-lookup-ppcre-root "#register-groups-bind"))
        ("do-scans" (cl-lookup-ppcre-root "#do-scans"))
        ("do-matches" (cl-lookup-ppcre-root "#do-matches"))
        ("do-matches-as-strings"
         (cl-lookup-ppcre-root "#do-matches-as-strings"))
        ("do-register-groups" (cl-lookup-ppcre-root "#do-register-groups"))
        ("all-matches" (cl-lookup-ppcre-root "#all-matches"))
        ("all-matches-as-strings"
         (cl-lookup-ppcre-root "#all-matches-as-strings"))
        ("split" (cl-lookup-ppcre-root "#split"))
        ("regex-replace" (cl-lookup-ppcre-root "#regex-replace"))
        ("regex-replace-all" (cl-lookup-ppcre-root "#regex-replace-all"))
        ("regex-apropos" (cl-lookup-ppcre-root "#regex-apropos"))
        ("regex-apropos-list" (cl-lookup-ppcre-root "#regex-apropos-list"))
        ("regex-char-code-limit"
         (cl-lookup-ppcre-root "#regex-char-code-limit"))
        ("use-bmh-matchers" (cl-lookup-ppcre-root "#use-bmh-matchers"))
        ("*allow-quoting*" (cl-lookup-ppcre-root "#*allow-quoting*"))
        ("quote-meta-chars" (cl-lookup-ppcre-root "#quote-meta-chars"))
        ("ppcre-error" (cl-lookup-ppcre-root "#ppcre-error"))
        ("ppcre-invocation-error"
         (cl-lookup-ppcre-root "#ppcre-invocation-error"))
        ("ppcre-syntax-error" (cl-lookup-ppcre-root "#ppcre-syntax-error"))
