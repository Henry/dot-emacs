...
(custom-set-variables
 ...
 '(newsticker-cache-filename "~/Emacs/Newsticker/Cache")
 '(newsticker-display-interval 15.3)
 '(newsticker-groups-filename "~/Emacs/Newsticker/Groups")
 '(newsticker-html-renderer (quote newsticker-htmlr-render))
 '(newsticker-imagecache-dirname "~/Emacs/Newsticker/Images")
 '(newsticker-keep-obsolete-items nil)
 '(newsticker-scroll-smoothly nil)
 '(newsticker-sort-method (quote sort-by-time))
 '(newsticker-url-list (quote (("BBC News" "http://www.bbc.co.uk/syndication/feeds/news/ukfs_news/front_page/rss091.xml" nil nil nil) ("The Inquirer" "http://www.theinquirer.net/inquirer.rss" nil nil nil))))
...
(custom-set-faces
 ...
 '(elscreen-tab-background-face ((((type x w32 mac) (class color)) (:background "Gray75" :foreground "black" :box (:line-width -1 :style released-button)))))
 '(elscreen-tab-current-screen-face ((((class color)) (:background "grey90" :foreground "black" :box (:line-width 2 :color "grey40" :style released-button) :weight bold))))
 '(elscreen-tab-other-screen-face ((((type x w32 mac) (class color)) (:background "Gray90" :foreground "grey20" :box (:line-width -1 :color "grey75")))))
 ...
 '(newsticker-date-face ((t (:slant italic :height 0.8 :family "Monospace"))))
 '(newsticker-enclosure-face ((t (:background "orange" :weight bold :family "Monospace"))))
 '(newsticker-extra-face ((t (:foreground "gray50" :slant italic :height 0.8 :family "Monospace"))))
 '(newsticker-feed-face ((t (:foreground "black" :weight bold :height 1.2 :family "Monospace"))))
 '(newsticker-immortal-item-face ((t (:foreground "blue" :slant italic :weight bold :family "Monospace"))))
 '(newsticker-new-item-face ((t (:weight bold :family "Monospace"))))
 '(newsticker-obsolete-item-face ((t (:strike-through t :weight bold :family "Monospace"))))
 '(newsticker-old-item-face ((t (:foreground "red4" :weight bold :family "Monospace"))))
 '(newsticker-statistics-face ((t (:slant italic :height 0.8 :family "Monospace"))))
 '(newsticker-treeview-face ((t (:inherit default :foreground "black" :weight normal))))
