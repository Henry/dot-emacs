...
(add-to-list  'load-path (car (last (file-expand-wildcards "~/.emacs.d/elpa/avy-[0-9.]*"))))
(add-to-list  'load-path (car (last (file-expand-wildcards "~/.emacs.d/elpa/ivy-[0-9.]*"))))
(add-to-list  'load-path (car (last (file-expand-wildcards "~/.emacs.d/elpa/avy-[0-9.]*"))))
(add-to-list  'load-path (car (last (file-expand-wildcards "~/.emacs.d/elpa/counsel-[0-9.]*"))))
(add-to-list  'load-path (car (last (file-expand-wildcards "~/.emacs.d/elpa/swiper-[0-9.]*"))))
...
(add-to-list  'load-path (car (last (file-expand-wildcards "~/.emacs.d/elpa/company-quickhelp-[0-9.]*"))))
...
(add-to-list  'load-path (car (last (file-expand-wildcards "~/.emacs.d/elpa/thing-cmds-[0-9.]*"))))
(add-to-list  'load-path (car (last (file-expand-wildcards "~/.emacs.d/elpa/thingatpt+-[0-9.]*"))))
(add-to-list  'load-path (car (last (file-expand-wildcards "~/.emacs.d/elpa/hide-comnt-[0-9.]*"))))
...
(add-to-list  'load-path (car (last (file-expand-wildcards "~/.emacs.d/elpa/projectile-[0-9.]*"))))
(add-to-list  'load-path (car (last (file-expand-wildcards "~/.emacs.d/elpa/counsel-projectile-[0-9.]*"))))
